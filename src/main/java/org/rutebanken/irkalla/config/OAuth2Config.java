...
public class OAuth2Config {
     ...
     */
    @Bean
    public RorAuth0RolesClaimAdapter rorAuth0RolesClaimAdapter(@Value("${irkalla.oauth2.resourceserver.auth0.ror.claim.namespace}") String rorAuth0ClaimNamespace) {
     ...
     */
    @Bean
    public MultiIssuerAuthenticationManagerResolver multiIssuerAuthenticationManagerResolver(@Value("${irkalla.oauth2.resourceserver.keycloak.jwt.audience}") String keycloakAudience,
                                                                                             @Value("${irkalla.oauth2.resourceserver.keycloak.jwt.issuer-uri}") String keycloakIssuer,
                                                                                             @Value("${irkalla.oauth2.resourceserver.keycloak.jwt.jwkset-uri}") String keycloakJwksetUri,
                                                                                             @Value("${irkalla.oauth2.resourceserver.auth0.ror.jwt.audience}") String rorAuth0Audience,
                                                                                             @Value("${irkalla.oauth2.resourceserver.auth0.ror.jwt.issuer-uri}") String rorAuth0Issuer,
