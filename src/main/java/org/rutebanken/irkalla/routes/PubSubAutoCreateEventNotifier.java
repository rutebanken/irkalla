...
public class PubSubAutoCreateEventNotifier extends EventNotifierSupport {
    ...
    private void createSubscriptionIfMissing(Endpoint e) {
        GooglePubsubEndpoint gep = switch (e) {
            ...
            case DefaultInterceptSendToEndpoint defaultInterceptSendToEndpoint when defaultInterceptSendToEndpoint.getOriginalEndpoint() instanceof GooglePubsubEndpoint googlePubsubEndpoint ->
                    googlePubsubEndpoint;
            case MasterEndpoint masterEndpoint when masterEndpoint.getEndpoint() instanceof DefaultInterceptSendToEndpoint defaultInterceptSendToEndpoint ->
