...
//todo: this class should be removed and the StopPlaceQuery should be used instead when tiamat is updated to support the new query

@JsonInclude(JsonInclude.Include.NON_NULL)
public class StopPlaceQueryLegacyCoordinates {
    ...
    public StopPlaceQueryLegacyCoordinates(String stopPlaceId, Long version) {
