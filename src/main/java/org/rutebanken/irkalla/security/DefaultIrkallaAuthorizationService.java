...
public class DefaultIrkallaAuthorizationService implements IrkallaAuthorizationService {

    private final AuthorizationService<Long> authorizationService;

    public DefaultIrkallaAuthorizationService(AuthorizationService<Long> authorizationService) {
